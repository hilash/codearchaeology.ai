...
namespace DAL
{
    public class SqlHelper
    {
        private static string ConnectionString
        {
            get
            {
                return @"Data Source=.\SQLEXPRESS;AttachDbFilename=D:\Hila\DB\DB.mdf;Integrated Security=True;User Instance=True";
            }
        ...
        public static int GetNextID(DataTable dt)
        {
        ...
        /*
                static void Main(string[] args)
                {
                    ...
                    FullConnected("INSERT INTO tblArtist(Artist_ID,Artist_Type,Artist_Name) values(5,'" + x + "','" + x + "')");
