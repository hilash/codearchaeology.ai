...
namespace BL
{
    public class MainClass
    {
        public static void Main()
        {
            ...
            //UP.getUserData(1);
            ////DAL.SqlHelper.PrintDataTable(DAL.Join.getSongsByUser(1));
            ////DAL.SqlHelper.PrintDataTable(UP.songs);
            //Console.ReadKey();

           // SongsPage.SongPopTableWithUserLikes(1);

            AlbumsPage AP = new AlbumsPage();
            AP.getData();
            DAL.SqlHelper.PrintDataTable(AP.LastAlbumAdded);
