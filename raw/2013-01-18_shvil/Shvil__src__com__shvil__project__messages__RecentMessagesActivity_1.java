...
public class RecentMessagesActivity extends ListActivity {
	...
	@Override
	  public void onCreate(Bundle savedInstanceState) {
	    ...
	    datasource.createMessage("Hello World!", now, x,  2, 0, 0);
	    now = System.currentTimeMillis();
	    x = ran.nextInt(4);
	    datasource.createMessage("What's up???",now, x,  1, 0, 0);
	    datasource.createUser("Bob", null);
	    datasource.createUser("Alice", null);
	     */
	    addMessagesUser();
