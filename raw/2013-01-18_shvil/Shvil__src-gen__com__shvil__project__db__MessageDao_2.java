...
public class MessageDao extends AbstractDao<Message, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property SenderId = new Property(4, long.class, "senderId", false, "SENDER_ID");
        public final static Property ReceiverId = new Property(5, long.class, "receiverId", false, "RECEIVER_ID");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MESSAGE' (" + //
                ...
                "'RECEIVER_ID' INTEGER NOT NULL ," + // 5: receiverId
    ...
    protected void bindValues(SQLiteStatement stmt, Message entity) {
        ...
        stmt.bindLong(6, entity.getReceiverId());
    ...
    public Message readEntity(Cursor cursor, int offset) {
        Message entity = new Message( //
            ...
            cursor.getLong(offset + 4), // senderId
            cursor.getLong(offset + 5), // receiverId
    ...
    public void readEntity(Cursor cursor, Message entity, int offset) {
        ...
        entity.setSenderId(cursor.getLong(offset + 4));
        entity.setReceiverId(cursor.getLong(offset + 5));
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN USER T1 ON T.'RECEIVER_ID'=T1.'_id'");
            builder.append(' ');
    ...
    protected Message loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        User messageSenderId = loadCurrentOther(daoSession.getUserDao(), cursor, offset);
         if(messageSenderId != null) {
            entity.setMessageSenderId(messageSenderId);
        }
        offset += daoSession.getUserDao().getAllColumns().length;

        User messageReceiverId = loadCurrentOther(daoSession.getUserDao(), cursor, offset);
         if(messageReceiverId != null) {
            entity.setMessageReceiverId(messageReceiverId);
        }
