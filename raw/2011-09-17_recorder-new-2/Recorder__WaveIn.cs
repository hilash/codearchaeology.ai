...
namespace Wave
{
    ...
    public class WaveIn : IDisposable
    {
        ...
        //Mutex isRecording; // TODO - change this Mutex
        //Mutex isBufferAvailable;
        byte[] waveArray;

        // TODO: add waveInGetErrorText
        /*******************************************************************
         * WaveIn Public Functions
         *******************************************************************/
        /// <summary>
        ...
        public void stopDevice()
        {
            ...
            int sizeOfAudioData = (int)(numberOfBuffersWritten * (int)numberOfSamples * waveFormat.nBlockAlign);
        ...
        public void getBuffer(byte[] outputBuffer)
        {
            //isBufferAvailable.WaitOne();
            outputBuffer = waveArray;
