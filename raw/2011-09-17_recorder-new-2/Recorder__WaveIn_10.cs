    ...
    public class WaveIn
    {
        ...
        */
        ...
        public WaveIn(uint paramNumberOfSamples, uint paramSamplesPerSec)
        {
            ...
            waveBuffer = new byte[numberOfSamples];
        ...
        public void recordBuffer(byte[] waveArray, int sleepTime)
        {
            ...
            if (numberOfSamples > waveBuffer.Length)
            {
                string message = "The length of the buffer for recording given is" + waveBuffer.Length.ToString() +
