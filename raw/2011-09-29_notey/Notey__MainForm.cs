...
namespace Recorder
{
    ...
    public partial class MainForm : Form
    {
        ...
        /// Must be a power of 2 (for the fourier transfrom analysis).
        ...
        /// <summary>
        /// Responsbile for recording from microphone
        /// </summary>
        WaveIn Wave;

        /// <summary>
        /// Contains the current audio samples
        /// </summary>
        byte[] WaveArray;

        /// <summary>
        /// Contains the frequency analysis of the recorded samples
        /// </summary>
        double[] WaveArrayFrequency;

        /// <summary>
        /// Holds the logic for the FFT (frequency analysis)
        /// </summary>
        ...
        public MainForm()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(error_message, "Notey");
        ...
        private void toolStripButtonRefresh_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message + "\n\n Please check the software configuration", "Notey");
        ...
        /// <summary>
        /// The program recording thread, that contains all the 'heart & logic' of the program.
        /// This thread runs a loop (that stops only then the user press the stop button),
        /// that responsible for recording from michrophone, analyze the sample and update the
        /// program if it has been a note or note (and of course update the GUI).
        /// </summary>
        private void RecordingLoop()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (!(ex is WaveInException || ex is FourierTransformException))
                {
