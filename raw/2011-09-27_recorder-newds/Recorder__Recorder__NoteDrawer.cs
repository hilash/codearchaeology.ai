...
namespace Notes
{
    ...
    class NoteDrawer
    {
        ...
        const float heigthBetweenStaves = 80;
        ...
        */
        ...
        public NoteDrawer()
        {
            lock (this)
            {
                ...
                Image GClefSource = Recorder.Properties.Resources.GClefPicture;
                Image noteFlagUpSource = Recorder.Properties.Resources.noteflagup;
                Image noteFlagDownSource = Recorder.Properties.Resources.noteflagdown;
                GClef = new Bitmap(GClefSource, (int)(heightOfStave * 0.5), (int)(heightOfStave * 1.3));
                noteFlagUp = new Bitmap(noteFlagUpSource, (int)(heightOfStave * 0.5), (int)(heightOfStave * 1.3));
                noteFlagDown = new Bitmap(noteFlagDownSource, (int)(heightOfStave * 0.5), (int)(heightOfStave * 1.3));
            }
        }
        ...
        /// <param name="brushSheet"></param>
        /// <param name="brushNote"></param>
        /// <param name="note"></param>
        /// <returns>Number of Notes can be displayed</returns>
        ...
        /// <summary>
        /// Given List of Notes and their colors, simply draw them.
        /// </summary>
        /// <param name="graphics"></param>
        /// <param name="notes"></param>
        /// <param name="notesColors"></param>
        /// <returns>number of notes that can be drawen</returns>
        ...
        private void DrawNote(Graphics graph, Brush brush, PointF point, Note note)
        {
            ...
            {
                case 125:
                    graph.DrawLines(new Pen(brush, 2F), noteLine); // drow a 
                    break;
                case 250:
