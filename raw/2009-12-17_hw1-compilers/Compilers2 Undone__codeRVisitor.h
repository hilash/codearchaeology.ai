#ifndef CODERVISITOR_H_
#define CODERVISITOR_H_

#include "Visitor.h"

class CodeRVisitor : public Visitor
{
public:
	CodeRVisitor(ostream & OutputFile_);
	...
	virtual ~CodeRVisitor();
};

#endif /*CODERVISITOR_H_*/
