#ifndef CODELVISITOR_H_
#define CODELVISITOR_H_

#include "Visitor.h"

class CodeLVisitor : public Visitor
{
public:
	CodeLVisitor(ostream & OutputFile_);
	...
	virtual ~CodeLVisitor();
};

#endif /*CodeLVisitor_H_*/
