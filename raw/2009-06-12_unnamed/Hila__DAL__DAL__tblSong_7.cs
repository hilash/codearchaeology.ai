...
namespace DAL
{
    public class tblSong : SqlHelper
    {
        ...
        {
            string SS = "SELECT * FROM tblSong WHERE Song_Name LIKE '%";
            SS += Song_Name;
            SS += "%'";

            return GetDataTable(SS, "tblSong");
        }
        ...
        {
            return GetDataTable("SELECT Song_ID FROM tblSong WHERE Artist_ID='" + Artist_ID + "'", "tblSong");
        }
        ...
        {
            return GetDataTable("SELECT Song_ID FROM tblSong WHERE Album_ID='" + Album_ID + "'", "tblSong");
        }
