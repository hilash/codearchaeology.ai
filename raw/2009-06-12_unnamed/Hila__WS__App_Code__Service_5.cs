...
public class Service : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public bool ULogin(string mail, string pass)
    {
    ...
    {
        return DAL.tblUser.InsertUser(User_ID, User_Fname, User_Lname, User_Bday, User_Gender, User_Pass, User_Email);
    }

    [WebMethod]
    public DataTable ArtistPopTable()
    {
        return DAL.tblArtist.ArtistPopTable();
    }
