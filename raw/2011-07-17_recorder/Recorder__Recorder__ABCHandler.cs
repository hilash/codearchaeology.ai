...
namespace Recorder
{
    class ABCHandler
    {
        ...
        public void init()
        {
            ...
            ABCfileName = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".abc";
        ...
        public string ConvertToPDF()
        {
            ...
            // system (run convertion): abcm2ps.exe ABCfile... some flags PSfile


            // Step2: .PS --> .PDF
            string PDFfileName = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".pdf";
