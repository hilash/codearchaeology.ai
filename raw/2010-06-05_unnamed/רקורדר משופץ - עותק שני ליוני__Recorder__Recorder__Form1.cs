    ...
    public partial class Form1 : Form
{
        ...
        public Form1()
        {
            ...
            {
                // STEP 2: let the user select a sound input device from the pool
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            objGraphic1.DrawLine(pen, 0, timeDomain.Size.Height / 2, timeDomain.Size.Width, timeDomain.Size.Height / 2);
