    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            try
            {
                ...
                pictureRecorderGraphics = pictureRecorder.CreateGraphics();
        ...
        private void printGraph(Graphics graph, int[] wave, int maxAmplitude, Color background, Pen foreground, int maxSample)
        {
            ...
            /*
            if ((true == stretch_graph) || (wave.Length < width))
            {
            ...
            try
            {
                ...
                while (is_recording)
                {
                    ...
                    if (printGraphsEnabled)
                    {
                        ...
                        printGraph(timeDomainGraphics, tmpArray, byte.MaxValue, Color.FromArgb(39, 40, 34), pen, tmpArray.Length);
                        if (!is_recording) { return; }
                    ...
                    if (true == abc_handler.addNoteToMusicSheet(currentNote.note))
                    {
        ...
        /// <summary>
        /// don't print graphics while in other tabs
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void tabControl1_Selected(object sender, TabControlEventArgs e)
        {
            if (tabPDF.SelectedTab.AccessibleName == "tabTransform")
            {
                printGraphsEnabled = true;
                // graphics
                timeDomainGraphics = timeDomain.CreateGraphics();
