...
namespace Analysis
{
    ...
    public class FurierTransform
    {
        ...
        public double preformTranform(TRANSFORM transform, byte[] inputBuffer, double[] outputBuffer, uint numberOfSamples, uint samplesPerSec)
        {
            double maxPitch = 0;
            ...
            if (false == IsPowerOfTwo((ulong)numberOfSamples))
            {
                ...
                throw new FurierTransformException(message);
            }
